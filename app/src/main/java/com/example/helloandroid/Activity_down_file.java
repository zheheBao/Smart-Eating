...
import com.example.helloandroid.bean.PackageInfo;
import com.example.helloandroid.util.DateUtil;

@SuppressLint("SetTextI18n")
public class Activity_down_file extends AppCompatActivity {
    ...
    class ApkUrlSelectedListener implements AdapterView.OnItemSelectedListener {
        public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
            ...
            down.setDestinationInExternalFilesDir(
                    Activity_down_file.this, Environment.DIRECTORY_DOWNLOADS, arg2 + ".apk");
