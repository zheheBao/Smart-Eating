...
import com.example.helloandroid.util.SwitchUtil;
/*
public class Activity_gps_setting extends AppCompatActivity {
...
public class Activity_gps_setting extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
